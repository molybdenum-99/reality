...
module Reality::Describers::Wikidata::Impl
  module Modules
    ...
    module Wbsearch
      ...
      # @private
      def _type(value)
        defined?(super) && super || ["item", "property"].include?(value.to_s) && merge(wbstype: value.to_s)
      end
